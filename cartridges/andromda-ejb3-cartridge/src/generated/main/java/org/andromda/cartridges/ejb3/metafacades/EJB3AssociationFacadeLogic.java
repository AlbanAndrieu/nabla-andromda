 ...
 * MetafacadeLogic for EJB3AssociationFacade
 *
 * @see EJB3AssociationFacade
 */
public abstract class EJB3AssociationFacadeLogic
    ...
    implements EJB3AssociationFacade
{
     ...
     * @param context String. Set to EJB3AssociationFacade if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.ejb3.metafacades.EJB3AssociationFacade";
        }
        return context;
    }
