 ...
 */
public abstract class EJB3EnumerationFacadeLogic
    ...
    implements EJB3EnumerationFacade
{
     ...
     * @param context String. Set to EJB3EnumerationFacade if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.ejb3.metafacades.EJB3EnumerationFacade";
        }
        return context;
    }
     ...
     * @return String
     */
    protected abstract String handleGetMemberVariablesAsList(Collection variables, boolean includeTypes, boolean includeNames);
     ...
     * If <code>true</code> the attribute names are included.
     * @return handleGetMemberVariablesAsList(variables, includeTypes, includeNames)
     */
    public String getMemberVariablesAsList(Collection variables, boolean includeTypes, boolean includeNames)
    {
        // getMemberVariablesAsList has no pre constraints
        String returnValue = handleGetMemberVariablesAsList(variables, includeTypes, includeNames);
        // getMemberVariablesAsList has no post constraints
        return returnValue;
    }
