 ...
 * @see EJB3TypeFacade
 */
public abstract class EJB3TypeFacadeLogic
    ...
    implements EJB3TypeFacade
{
     ...
     * @param context String. Set to EJB3TypeFacade if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.ejb3.metafacades.EJB3TypeFacade";
        }
        return context;
    }
    ...
    */
     ...
     * @return (String)handleGetFullyQualifiedEJB3Type()
     */
