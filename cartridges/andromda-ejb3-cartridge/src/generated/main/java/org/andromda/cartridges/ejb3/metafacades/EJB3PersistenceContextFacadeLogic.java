 ...
 * MetafacadeLogic for EJB3PersistenceContextFacade
 *
 * @see EJB3PersistenceContextFacade
 */
public abstract class EJB3PersistenceContextFacadeLogic
    ...
    implements EJB3PersistenceContextFacade
{
     ...
     * @param context String. Set to EJB3PersistenceContextFacade if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.ejb3.metafacades.EJB3PersistenceContextFacade";
        }
        return context;
    }
    ...
    */
     ...
     * @return (String)handleGetUnitName()
     */
    ...
    */
     ...
     * @return (String)handleGetContextType()
     */
   ...
   /**
    * @see org.andromda.cartridges.ejb3.metafacades.EJB3PersistenceContextFacade#getDatasource()
    * @return String
    */
     ...
     * @return (String)handleGetDatasource()
     */
