 ...
 */
public abstract class EJB3EmbeddedValueFacadeLogic
    ...
    implements EJB3EmbeddedValueFacade
{
     ...
     * @param context String. Set to EJB3EmbeddedValueFacade if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.ejb3.metafacades.EJB3EmbeddedValueFacade";
        }
        return context;
    }
    ...
    */
     ...
     * @return (boolean)handleIsImmutable()
     */
   ...
   /**
    * @see org.andromda.cartridges.ejb3.metafacades.EJB3EmbeddedValueFacade#getFullyQualifiedImplementationName()
    * @return String
    */
