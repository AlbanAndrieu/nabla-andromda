 ...
 */
public abstract class EJB3InterceptorFacadeLogic
    ...
    implements EJB3InterceptorFacade
{
     ...
     * @param context String. Set to EJB3InterceptorFacade if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.ejb3.metafacades.EJB3InterceptorFacade";
        }
        return context;
    }
    ...
    */
     ...
     * @return (String)handleGetInterceptorName()
     */
    ...
    */
     ...
     * @return (String)handleGetFullyQualifiedInterceptorName()
     */
   ...
   /**
    * @see org.andromda.cartridges.ejb3.metafacades.EJB3InterceptorFacade#getInterceptorReferences()
    * @return Collection
    */
   ...
   /**
    * @see org.andromda.cartridges.ejb3.metafacades.EJB3InterceptorFacade#isDefaultInterceptor()
    * @return boolean
    */
     ...
     * @return (boolean)handleIsDefaultInterceptor()
     */
