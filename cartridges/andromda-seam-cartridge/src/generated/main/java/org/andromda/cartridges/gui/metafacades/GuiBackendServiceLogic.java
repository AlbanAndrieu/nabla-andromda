 ...
 */
public abstract class GuiBackendServiceLogic
    ...
    implements GuiBackendService
{
     ...
     * @param context String. Set to GuiBackendService if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.gui.metafacades.GuiBackendService";
        }
        return context;
    }
