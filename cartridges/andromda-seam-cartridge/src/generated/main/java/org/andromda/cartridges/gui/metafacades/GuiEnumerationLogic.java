 ...
 * MetafacadeLogic for GuiEnumeration
 *
 * @see GuiEnumeration
 */
public abstract class GuiEnumerationLogic
    ...
    implements GuiEnumeration
{
     ...
     * @param context String. Set to GuiEnumeration if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.gui.metafacades.GuiEnumeration";
        }
        return context;
    }
