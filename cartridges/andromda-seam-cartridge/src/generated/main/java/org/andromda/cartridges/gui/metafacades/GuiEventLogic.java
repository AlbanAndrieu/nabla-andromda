 ...
 * MetafacadeLogic for GuiEvent
 *
 * @see GuiEvent
 */
public abstract class GuiEventLogic
    ...
    implements GuiEvent
{
     ...
     * @param context String. Set to GuiEvent if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.gui.metafacades.GuiEvent";
        }
        return context;
    }
     ...
     * @see GuiEvent
     */
    public boolean isGuiEventMetaType()
    {
        return true;
    }
