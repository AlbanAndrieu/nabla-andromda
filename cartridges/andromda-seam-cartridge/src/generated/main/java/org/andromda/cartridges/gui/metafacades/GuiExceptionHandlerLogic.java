 ...
 */
public abstract class GuiExceptionHandlerLogic
    ...
    implements GuiExceptionHandler
{
     ...
     * @param context String. Set to GuiExceptionHandler if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.gui.metafacades.GuiExceptionHandler";
        }
        return context;
    }
            ...
            if (!constraintValid)
            {
                validationMessages.add(
                    new ModelValidationMessage(
                        ...
                        "org::andromda::cartridges::gui::metafacades::GuiExceptionHandler::must target page or final state",
                        "When you model an action-exception you must either target a FrontEndView action state or a final state."));
            }
        }
        catch (Throwable th)
        {
            ...
            logger.error("Error validating constraint 'org::andromda::cartridges::gui::metafacades::GuiExceptionHandler::must target page or final state' ON "
