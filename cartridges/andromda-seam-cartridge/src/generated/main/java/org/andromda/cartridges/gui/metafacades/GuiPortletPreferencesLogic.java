 ...
 * MetafacadeLogic for GuiPortletPreferences
 *
 * @see GuiPortletPreferences
 */
public abstract class GuiPortletPreferencesLogic
    ...
    implements GuiPortletPreferences
{
     ...
     * @param context String. Set to GuiPortletPreferences if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.gui.metafacades.GuiPortletPreferences";
        }
        return context;
    }
     ...
     * Represents the portlet preferences for a given use case (assuming the JSF application being
     * generated is a portlet).
     * @return (GuiUseCase)handleGetUseCase()
     */
    public final GuiUseCase getUseCase()
    {
        GuiUseCase getUseCase1r = null;
        // preferences has no pre constraints
        Object result = handleGetUseCase();
        MetafacadeBase shieldedResult = this.shieldedElement(result);
        try
        {
            getUseCase1r = (GuiUseCase) shieldedResult;
        }
