 ...
 * MetafacadeLogic for GuiController
 *
 * @see GuiController
 */
public abstract class GuiControllerLogic
    ...
    implements GuiController
{
     ...
     * @param context String. Set to GuiController if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.gui.metafacades.GuiController";
        }
        return context;
    }
   ...
   /**
    * @see org.andromda.cartridges.gui.metafacades.GuiController#getFullPath()
    * @return String
    */
    ...
    */
    protected abstract List<DependencyFacade> handleGetSessionObjectReferences();
     ...
     * @return  List
     */
    protected abstract List handleGetAllArguments();
    ...
    /**
     * <p><b>Constraint:</b> org::andromda::cartridges::gui::metafacades::GuiController::controller must have a name</p>
     * <p><b>Error:</b> Each controller must have a name, it cannot be empty.</p>
     * <p><b>OCL:</b> context GuiController inv: name->notEmpty()</p>
     * <p><b>Constraint:</b> org::andromda::cartridges::gui::metafacades::GuiController::unique operation names</p>
     * <p><b>Error:</b> A controller cannot have different operations with the same name, even if they have a different signature.</p>
     * <p><b>OCL:</b> context GuiController inv: operations->isUnique(name)</p>
     * <p><b>Constraint:</b> org::andromda::cartridges::gui::metafacades::GuiController::controller name should not resemble the usecase name</p>
     * <p><b>Error:</b> The name of this front-end controller resembles the name of the use-case it is associated with. You'll have to rename it in order to avoid naming collisions (generated files will overwrite eachother).</p>
     * <p><b>OCL:</b> context GuiController inv: name <> useCase.activityGraph.firstAction.actionClassName</p>
            ...
            if (!constraintValid)
            {
                validationMessages.add(
                    new ModelValidationMessage(
                        ...
                        "org::andromda::cartridges::gui::metafacades::GuiController::controller must have a name",
                        "Each controller must have a name, it cannot be empty."));
            }
        }
        catch (Throwable th)
        {
            ...
            logger.error("Error validating constraint 'org::andromda::cartridges::gui::metafacades::GuiController::controller must have a name' ON "
                + this.THIS().toString() + ": " + th.getMessage(), th);
        }
        try
        {
            final Object contextElement = this.THIS();
            boolean constraintValid = OCLResultEnsurer.ensure(OCLCollections.isUnique(OCLIntrospector.invoke(contextElement,"operations"),new Transformer(){public Object transform(Object object){return OCLIntrospector.invoke(object,"name");}}));
            if (!constraintValid)
            {
                validationMessages.add(
                    new ModelValidationMessage(
                        (MetafacadeBase)contextElement ,
                        "org::andromda::cartridges::gui::metafacades::GuiController::unique operation names",
                        "A controller cannot have different operations with the same name, even if they have a different signature."));
            }
        }
        catch (Throwable th)
        {
            ...
            logger.error("Error validating constraint 'org::andromda::cartridges::gui::metafacades::GuiController::unique operation names' ON "
                + this.THIS().toString() + ": " + th.getMessage(), th);
        }
        try
        {
            final Object contextElement = this.THIS();
            boolean constraintValid = OCLResultEnsurer.ensure(OCLExpressions.notEqual(OCLIntrospector.invoke(contextElement,"name"),OCLIntrospector.invoke(contextElement,"useCase.activityGraph.firstAction.actionClassName")));
            if (!constraintValid)
            {
                validationMessages.add(
                    new ModelValidationMessage(
                        (MetafacadeBase)contextElement ,
                        "org::andromda::cartridges::gui::metafacades::GuiController::controller name should not resemble the usecase name",
                        "The name of this front-end controller resembles the name of the use-case it is associated with. You'll have to rename it in order to avoid naming collisions (generated files will overwrite eachother)."));
            }
        }
        catch (Throwable th)
        {
            ...
            logger.error("Error validating constraint 'org::andromda::cartridges::gui::metafacades::GuiController::controller name should not resemble the usecase name' ON "
                + this.THIS().toString() + ": " + th.getMessage(), th);
        }
    }
