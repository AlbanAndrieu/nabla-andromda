 ...
 */
public abstract class GuiSessionObjectLogic
    ...
    implements GuiSessionObject
{
     ...
     * @param context String. Set to GuiSessionObject if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.gui.metafacades.GuiSessionObject";
        }
        return context;
    }
...
inv : attributes -> forAll(visibility = 'public')</p>
    ...
    public void validateInvariants(Collection<ModelValidationMessage> validationMessages)
    {
        ...
        catch (Throwable th)
        {
            ...
            logger.error("Error validating constraint 'org::andromda::cartridges::gui::metafacades::GuiSessionObject::session object needs a name' ON "
        ...
        catch (Throwable th)
        {
            ...
            logger.error("Error validating constraint 'org::andromda::cartridges::gui::metafacades::GuiSessionObject::session object needs public attributes' ON "
                + this.THIS().toString() + ": " + th.getMessage(), th);
        }
    }
