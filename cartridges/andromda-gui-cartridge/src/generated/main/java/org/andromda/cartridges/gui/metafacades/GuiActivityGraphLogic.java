 ...
 */
public abstract class GuiActivityGraphLogic
    ...
    implements GuiActivityGraph
{
     ...
     * @param context String. Set to GuiActivityGraph if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.gui.metafacades.GuiActivityGraph";
        }
        return context;
    }
    ...
    public void validateInvariants(Collection<ModelValidationMessage> validationMessages)
    {
            ...
            if (!constraintValid)
            {
                validationMessages.add(
                    new ModelValidationMessage(
                        ...
                        "org::andromda::cartridges::gui::metafacades::GuiActivityGraph::graph must have an action modeled on it's initial state",
        ...
        catch (Throwable th)
        {
            ...
            logger.error("Error validating constraint 'org::andromda::cartridges::gui::metafacades::GuiActivityGraph::graph must have an action modeled on it's initial state' ON "
        ...
        try
        {
            ...
            if (!constraintValid)
            {
                validationMessages.add(
                    new ModelValidationMessage(
                        (MetafacadeBase)contextElement ,
                        "org::andromda::cartridges::gui::metafacades::GuiActivityGraph::front end graph must have a controller context",
        ...
        catch (Throwable th)
        {
            ...
            logger.error("Error validating constraint 'org::andromda::cartridges::gui::metafacades::GuiActivityGraph::front end graph must have a controller context' ON "
                + this.THIS().toString() + ": " + th.getMessage(), th);
        }
    }
