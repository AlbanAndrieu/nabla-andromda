...
REM call mvn -U dependency:tree -Psample,arq-jbossas-managed > dependency.log
call mvn -B dependency:tree -Psample,coverage,integration,run-its,arq-weld-ee-embedded > dependency.log
