...
public class SimpleSeamArquillianInjectTest extends JUnitSeamTest
{
    ...
    public static Archive<?> createTestArchive()
    {
        ...
        return ShrinkWrap.create(WebArchive.class, "core.war").addClasses(SimpleSeamArquillianInjectTest.class, Authenticator.class, AuthenticatorAction.class, UserDaoBase.class, UserServiceBean.class)
