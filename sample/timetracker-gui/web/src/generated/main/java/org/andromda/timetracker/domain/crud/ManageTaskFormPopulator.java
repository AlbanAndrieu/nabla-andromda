...
/**
 * This filter handles the population of forms for the <em>Task</code>
 * view.
 */
public class ManageTaskFormPopulator
    implements Filter
{
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            ManageTaskForm manageTaskForm =
                            ((TaskController)variableResolver.resolveVariable(
                            facesContext,
                            "taskController")).getForm();
            // - populate the forms
            if (form != null && form instanceof ManageTaskForm)
            {
                // - populate the manageTaskForm with any parameters from the previous form
                manageTaskForm.copyFrom((ManageTaskForm)form);
            }
            // - serialize the form
            if (form != null)
            {
