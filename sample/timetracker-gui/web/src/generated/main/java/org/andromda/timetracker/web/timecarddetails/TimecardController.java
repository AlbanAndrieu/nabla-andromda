...
public abstract class TimecardController
    ...
    private static final Log logger = LogFactory.getLog(TimecardController.class);
    ...
    {
        // Resets all the "isSet" flags on the forms to false.
        this.getTimecardDetailsForm().resetIsSetFlags();
    }

    /**
     * Retrieves the {@link TimecardDetailsFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>timecardDetailsTimecardDetailsForm</em> instance outside of its assigned controller operation).
     * @return TimecardDetailsFormImpl
     */
    protected TimecardDetailsFormImpl getTimecardDetailsForm()
    {
        ...
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "timecardDetailsTimecardDetailsForm");
        this.populateComponentInputs(uiForm);
        return (TimecardDetailsFormImpl)this.resolveVariable("timecardDetailsTimecardDetailsForm");
    }
...
TimecardDetailsFormImpl)
     * @param form
     */
    protected void _timecardDetails_started(TimecardDetailsFormImpl form)
    {
     ...
     */
    public String timecardDetails()
    {
        return timecardDetails((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void timecardDetails(final ActionEvent event)
    {
        this.timecardDetails((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void timecardDetails(final ValueChangeEvent event)
    {
        this.timecardDetails((FacesEvent)event);
    }
    ...
    public String timecardDetails(final FacesEvent event)
    {
        ...
        try
        {
            final TimecardDetailsFormImpl form =
                this.getTimecardDetailsForm();
            form.setEvent(event);
     ...
     * @throws Throwable
     */
    protected String _populateScreen(final TimecardDetailsFormImpl form)
        throws Throwable
    {
        String forward = null;
