...
public abstract class SearchController
     ...
     * @throws Throwable
     */
    public abstract void populateSearchScreen(PopulateSearchScreenForm form)
        throws Throwable;
     ...
     * @throws Throwable
     */
    public abstract void initializeTimecardId(InitializeTimecardIdForm form)
        throws Throwable;
    ...
    protected SearchTimecardsSearchFormImpl getSearchTimecardsSearchForm()
    {
        ...
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "searchTimecardsSearchTimecardsSearchForm");
...
SearchTimecardsSearchFormImpl)
    ...
    public String searchTimecardsSearch(final FacesEvent event)
    {
        ...
        try
        {
            final SearchTimecardsSearchFormImpl form =
                this.getSearchTimecardsSearchForm();
            form.setEvent(event);
...
SearchTimecardsDetailsFormImpl)
    ...
    public String searchTimecardsDetails(final FacesEvent event)
    {
        ...
        try
        {
            final SearchTimecardsDetailsFormImpl form =
                this.getSearchTimecardsDetailsForm();
            form.setEvent(event);
            this.setForm("form", form, true);
            // - pass any properties from the previous form along
            FormPopulator.populateForm(currentForm, form, false);
...
SearchTimecardsFormImpl)
    ...
    public String searchTimecards(final FacesEvent event)
    {
        ...
        try
        {
            final SearchTimecardsFormImpl form =
                this.getSearchTimecardsForm();
            form.setEvent(event);
            this.setForm("form", form, true);
            // - pass any properties from the previous form along
            FormPopulator.populateForm(currentForm, form, false);
