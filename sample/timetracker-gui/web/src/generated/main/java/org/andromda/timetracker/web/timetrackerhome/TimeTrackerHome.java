    ...
    extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        HomeController controller =
            (HomeController)FacesContextUtils.resolveVariable(
                request, response,
                "homeController");
        final String forwardPath = UseCaseForwards.getPath(controller.timeTrackerHome());
        if(forwardPath != null){
            TimeTrackerHomeViewPopulator.populateFormAndViewVariables(
