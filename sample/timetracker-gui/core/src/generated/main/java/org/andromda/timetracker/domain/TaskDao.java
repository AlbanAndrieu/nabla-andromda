...
public interface TaskDao
{
    ...
    /**
     * Transforms the given results to a collection of {@link Task}
    ...
    /**
     * Converts this DAO's entity to an array of instances of type {@link TaskVO}.
     * @param entities
     * @return TaskVO[]
     */
    public TaskVO[] toTaskVOArray(Collection<?> entities);
    ...
    /**
     * Gets an instance of Task from the persistent store.
     * @param id
     * @return Task
     */
     ...
     * flag is set to one of the constants defined in <code>org.andromda.timetracker.domain.TaskDao</code>, please note
     ...
     *
     * @param transform one of the constants declared in {@link org.andromda.timetracker.domain.TaskDao}
     ...
     *
     * @param transform one of the constants declared in <code>org.andromda.timetracker.domain.TaskDao</code>
    ...
    /**
     * Searches for a single instance of Task.
     * @param name the unique name to be used in the search.'
     * @return a single instance of Task.
     */
